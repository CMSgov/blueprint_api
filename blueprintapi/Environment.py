...
class Environment:
    def __init__(self):
        default_cors_headers        = ["accept","accept-encoding","access-control-allow-origin","authorization","content-type","dnt","origin","user-agent","x-csrftoken","x-requested-with",]
        ...
        self.cors_allow_headers     = os.environ.get("CORS_ALLOW_HEADERS", default_cors_headers)
        self.debug                  = os.environ.get("API_DEBUG", False)
