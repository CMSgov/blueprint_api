...
project_admin_permissions = [manage_project_users_permission, change_project_permission, view_project_permission]
...
project_permission_group = {PROJECT_ADMIN_GROUP: project_admin_permissions,
